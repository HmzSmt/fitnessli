...
<body>
<div class="container">
	<div class="box box1" onclick="window.location.href = 'series/Abdo1.php'">Premiére series</div>
	<div class="box box2" onclick="window.location.href = 'series/Abdo2.php'">Deuxiéme series</div>
	<div class="box box3" onclick="window.location.href = 'series/Abdo3.php'">Troisiéme series </div>
	</div>
</body>
</html>